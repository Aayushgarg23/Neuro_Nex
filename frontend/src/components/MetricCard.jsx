...
export default function MetricCard({ label, value, unit = '', icon, color = '#1A73E8', animate = true }) {
  ...
  return (
    <div className="clean-card p-4 relative overflow-hidden group cursor-default">
      ...
      <div className="flex items-start justify-between mb-3">
        ...
        <span className="badge badge-gray text-xs">{unit}</span>
      </div>
